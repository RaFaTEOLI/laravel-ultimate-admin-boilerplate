                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column nav-legacy" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item has-treeview">
                                <a href="#" class="nav-link">
                                    ...
                                    {{ __('Administration') }} <i class="right fa fa-angle-left"></i>
                                </a>
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{ route('users') }}" class="nav-link"><i class="nav-icon fa fa-users fa-fw" aria-hidden="true"></i> {{ __('Users') }}</a>
                                    </li>

                                    <li class="nav-item">
                                        <a href="{{ route('roles') }}" class="nav-link"><i class="nav-icon fa fa-user fa-fw" aria-hidden="true"></i> {{ __('Roles') }}</a>
                                    </li>

                                    <li class="nav-item">
                                        <a href="{{ route('permissions') }}" class="nav-link"><i class="nav-icon fa fa-lock fa-fw" aria-hidden="true"></i> {{ __('Permissions') }}</a>
                                    </li>
                                </ul>
                            </li>
                            @endif
                            ...
                            <!-- Other Routes -->
                            <li class="nav-item">
                                <a href="#" class="nav-link"><i class="nav-icon fa fa-users fa-fw"></i> {{ __('Other Route') }}</a>
                            </li>
                        </ul>
                    </nav>
                    <!-- /.sidebar-menu -->
